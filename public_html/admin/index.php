                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="<?= $atrasado ? 'color:#ef4444;font-weight:700' : '' ?>"><?= $p['gantt_fin'] ? date('d/m/Y', strtotime($p['gantt_fin'])) : '—' ?></td>
                                <td>
            ...
            <div class="card-view">
                <div class="project-grid">
                    ...
                    <div class="project-card">
                        ...
                        <div class="pc-dates">
                            <div class="pc-date pc-date-full"><label>Inicio</label><span><?= $p['fecha_inicio'] ? date('d/m/Y', strtotime($p['fecha_inicio'])) : '—' ?></span></div>
